...
from bria_houdini.node_utils import clamp_steps_num
...
# ---------------------------------------------------------------------------
# Viewport Restyle Preset Categories
# ---------------------------------------------------------------------------
CATEGORY_ORDER = [
    ("custom",          "Custom"),
...
PRESET_CATEGORIES = {
    ...
    "vfx_simulations": [
        ("destruction", "Destruction & Debris",
         "Render this destruction simulation as a photorealistic scene with realistic material fracturing, concrete dust clouds, scattered debris with detailed textures, dramatic directional lighting, and cinematic motion blur"),
        ("water_ocean", "Water & Ocean",
         "Render this water simulation as a photorealistic ocean scene with transparent refractive water, realistic foam and spray, caustic light patterns, subsurface scattering, and natural coastal lighting"),
        ("pyro_fire", "Fire & Explosions",
         "Render this fire simulation as a photorealistic scene with intense volumetric flames, glowing embers, heat distortion, realistic fire illumination on surrounding surfaces, and dramatic contrast between fire and shadow"),
        ("smoke_clouds", "Smoke & Clouds",
         "Render this smoke simulation as a photorealistic atmospheric scene with soft volumetric density, realistic light scattering through the volume, subtle color gradients, natural dissipation at the edges, and cinematic depth"),
        ("particles", "Particles & Sparks",
         "Render this particle simulation as a photorealistic scene with glowing sparks, motion-streaked trajectories, realistic light emission, soft bokeh on distant particles, and dramatic contrast against the environment"),
    ],

    # ---- Environments (6) ----
    "environments": [
        ("landscape_mountains", "Mountain Landscape",
         "Render this landscape as a photorealistic mountain vista with detailed rock textures, atmospheric haze in distant valleys, natural vegetation, volumetric cloud shadows, and epic wide-angle perspective"),
        ("landscape_forest", "Forest & Vegetation",
         "Render this scene as a photorealistic forest environment with detailed foliage, dappled light filtering through the canopy, rich ground cover, organic bark textures, and lush natural atmosphere"),
        ("landscape_desert", "Desert & Arid",
         "Render this scene as a photorealistic desert landscape with detailed sand textures, heat shimmer, dramatic rock formations, harsh directional sunlight, and vast arid atmosphere"),
        ("landscape_coastal", "Coastal & Beach",
         "Render this scene as a photorealistic coastal environment with turquoise water, wet sand reflections, detailed shoreline foam, natural coastal vegetation, and warm oceanic atmosphere"),
        ("building_exterior", "Building Exterior",
         "Render this architecture as a photorealistic building exterior with detailed material surfaces, accurate window reflections, natural weathering, surrounding landscaping, and realistic environmental lighting"),
        ("building_interior", "Building Interior",
         "Render this interior as a photorealistic room with accurate material textures, natural light from windows, subtle ambient occlusion, realistic furniture detail, and warm inviting atmosphere"),
    ],

    # ---- Lighting & Mood (6) ----
    "lighting_mood": [
        ("golden_hour", "Golden Hour",
         "Render this scene in golden hour lighting with rich warm amber sunlight, long dramatic shadows, glowing rim light on surfaces, soft atmospheric haze, and cinematic warmth"),
        ("night_scene", "Night Scene",
         "Render this scene as a photorealistic night environment with deep blue ambient light, practical light sources casting pools of warm illumination, subtle moonlight, realistic shadow falloff, and atmospheric night mood"),
        ("studio_lighting", "Studio Lighting",
         "Render this scene with professional studio lighting featuring clean three-point setup, soft key light, subtle fill, defined rim separation, neutral background, and polished product-photography quality"),
        ("overcast_soft", "Overcast & Soft",
         "Render this scene under soft overcast lighting with even diffused illumination, gentle shadow gradients, muted natural color, and calm atmospheric mood"),
        ("dramatic_contrast", "Dramatic & High Contrast",
         "Render this scene with dramatic high-contrast lighting featuring bold directional light, deep expressive shadows, strong chiaroscuro, and cinematic intensity"),
        ("neon_urban", "Neon & Urban Night",
         "Render this scene as a neon-lit urban night environment with vivid colored light reflections on wet surfaces, atmospheric fog catching light beams, cyberpunk-inspired mood, and high-contrast electric atmosphere"),
    ],

    # ---- Stylized (5) ----
    "stylized": [
        ("motion_graphics", "Motion Graphics",
         "Render this scene as a polished motion graphics piece with clean geometric forms, smooth material surfaces, vibrant brand-friendly colors, precise studio lighting, and sleek contemporary design aesthetic"),
        ("abstract_procedural", "Abstract Procedural Art",
         "Render this procedural pattern as detailed abstract art with rich material textures, iridescent surface qualities, dramatic focused lighting, organic flowing forms, and gallery-quality artistic presentation"),
        ("concept_art", "Concept Art",
         "Render this scene as professional concept art with painterly detail, atmospheric perspective, rich color palette, dramatic composition lighting, and the polished quality of feature-film pre-production artwork"),
        ("architectural_viz", "Architectural Visualization",
         "Render this scene as a professional architectural visualization with photorealistic material accuracy, precise natural lighting, clean geometric detail, subtle ambient occlusion, and high-end real estate presentation quality"),
        ("product_render", "Product Render",
         "Render this object as a professional product photograph with pristine material surfaces, precise studio lighting, subtle reflections, clean background separation, and commercial advertising quality"),
    ],
}
...
def call_bria_restyle(
    ...
    """Call Bria FIBO Edit API to restyle the viewport capture."""
...
def restyle_viewport(node) -> Optional[str]:
    ...
    try:
        ...
        if status_parm:
            status_parm.set("Restyling with FIBO Edit...")
