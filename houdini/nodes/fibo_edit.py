...
def fibo_edit_bria(cop_node: hou.Node) -> None:
    ...
    try:
        ...
        # Optional UI toggles in newer shells.
        enable_negative = _opt_parm_bool(cop_node, "enable_negative_prompt")
        enable_structured = _opt_parm_bool(cop_node, "enable_structured_prompt")
        ...
        out_path = os.path.join(temp_dir, f"bria_fibo_edit_result_{run_id}.png")
